...
export const Slider = ({
  ...
  const onBeforeChange = useCallback<OnBeforeChange>(() => setMoving(true), [setMoving])

  const onAfterChange = useCallback<OnAfterChange>(() => setMoving(false), [setMoving])
  ...
  const renderMark = useCallback<RenderMark>((props: any) => <span {...props} />, [])
