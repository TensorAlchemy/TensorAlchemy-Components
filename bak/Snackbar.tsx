...
const Snackbar = ReactImport.forwardRef<
  HTMLDivElement,
...
const ErrorSnackbar = ReactImport.forwardRef<HTMLDivElement, CustomContentProps>(
  (props, ref) => (
    <Snackbar
      {...props}
      ref={ref}
...
const WarningSnackbar = ReactImport.forwardRef<HTMLDivElement, CustomContentProps>(
  (props, ref) => (
    <Snackbar
      {...props}
      ref={ref}
...
const InfoSnackbar = ReactImport.forwardRef<HTMLDivElement, CustomContentProps>(
  (props, ref) => (
    <Snackbar
      {...props}
      ref={ref}
...
const SuccessSnackbar = ReactImport.forwardRef<HTMLDivElement, CustomContentProps>(
  (props, ref) => (
    <Snackbar
      {...props}
      ref={ref}
...
const DefaultSnackbar = ReactImport.forwardRef<HTMLDivElement, CustomContentProps>(
