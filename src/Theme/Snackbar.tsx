...
const ErrorSnackbar = ReactImport.forwardRef<
  HTMLDivElement,
  CustomContentProps
>((props, ref) => (
  <Snackbar
...
const WarningSnackbar = ReactImport.forwardRef<
  HTMLDivElement,
  CustomContentProps
>((props, ref) => (
  <Snackbar
...
const SuccessSnackbar = ReactImport.forwardRef<
  HTMLDivElement,
  CustomContentProps
>((props, ref) => (
  <Snackbar
...
const DefaultSnackbar = ReactImport.forwardRef<
  HTMLDivElement,
  CustomContentProps
